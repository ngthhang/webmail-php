...
<div class='col-xl-10 col-md-8 col-lg-8 p-0'>
    <div class='table-home-header sticky-top bg-white border-bottom' style="padding: 24px 30px">
        ...
        <div class='profile-container'>
            ...
            <div class='profile-info-container'>
                ...
                <div class='profile-row'>
                    ...
                    <input type="text" class='profile-input position col-10' <?= $disabled ?> onclick="onFocus()" value="<?= $user->position ?>" name="position">
                </div>
                <div class='profile-row'>
